...
export const TBL_PURCHASE_ORDER_HDR = StoEntriesSchema.table("TBL_PURCHASE_ORDER_HDR", {
  ...
  PRODUCT_HDR_AMOUNT: numeric("PRODUCT_HDR_AMOUNT", { precision: 30, scale: 4 }),
  TOTAL_ADDITIONAL_COST_AMOUNT: numeric("TOTAL_ADDITIONAL_COST_AMOUNT", { precision: 30, scale: 4 }),
  TOTAL_PRODUCT_HDR_AMOUNT: numeric("TOTAL_PRODUCT_HDR_AMOUNT", { precision: 30, scale: 4 }),
  TOTAL_VAT_HDR_AMOUNT: numeric("TOTAL_VAT_HDR_AMOUNT", { precision: 30, scale: 2 }),
  FINAL_PURCHASE_HDR_AMOUNT: numeric("FINAL_PURCHASE_HDR_AMOUNT", { precision: 30, scale: 2 }),
  EXCHANGE_RATE: numeric("EXCHANGE_RATE", { precision: 30, scale: 2 }),
  PRODUCT_HDR_AMOUNT_LC: numeric("PRODUCT_HDR_AMOUNT_LC", { precision: 30, scale: 4 }),
  TOTAL_ADDITIONAL_COST_AMOUNT_LC: numeric("TOTAL_ADDITIONAL_COST_AMOUNT_LC", { precision: 30, scale: 4 }),
  TOTAL_PRODUCT_HDR_AMOUNT_LC: numeric("TOTAL_PRODUCT_HDR_AMOUNT_LC", { precision: 30, scale: 4 }),
  TOTAL_VAT_HDR_AMOUNT_LC: numeric("TOTAL_VAT_HDR_AMOUNT_LC", { precision: 30, scale: 2 }),
  FINAL_PURCHASE_HDR_AMOUNT_LC: numeric("FINAL_PURCHASE_HDR_AMOUNT_LC", { precision: 30, scale: 2 }),
...
export const TBL_PURCHASE_ORDER_DTL = StoEntriesSchema.table("TBL_PURCHASE_ORDER_DTL", {
  ...
  TOTAL_QTY: numeric("TOTAL_QTY", { precision: 30, scale: 4 }),
  UOM: varchar("UOM", { length: 50 }),
  TOTAL_PACKING: numeric("TOTAL_PACKING", { precision: 30, scale: 4 }),
  ALTERNATE_UOM: varchar("ALTERNATE_UOM", { length: 500 }),
  RATE_PER_QTY: numeric("RATE_PER_QTY", { precision: 30, scale: 6 }),
  PRODUCT_AMOUNT: numeric("PRODUCT_AMOUNT", { precision: 30, scale: 4 }),
  DISCOUNT_PERCENTAGE: numeric("DISCOUNT_PERCENTAGE", { precision: 30, scale: 2 }),
  DISCOUNT_AMOUNT: numeric("DISCOUNT_AMOUNT", { precision: 30, scale: 4 }),
  TOTAL_PRODUCT_AMOUNT: numeric("TOTAL_PRODUCT_AMOUNT", { precision: 30, scale: 4 }),
  VAT_PERCENTAGE: numeric("VAT_PERCENTAGE", { precision: 30, scale: 2 }),
  VAT_AMOUNT: numeric("VAT_AMOUNT", { precision: 30, scale: 4 }),
  FINAL_PRODUCT_AMOUNT: numeric("FINAL_PRODUCT_AMOUNT", { precision: 30, scale: 4 }),
  TOTAL_PRODUCT_AMOUNT_LC: numeric("TOTAL_PRODUCT_AMOUNT_LC", { precision: 30, scale: 4 }),
  FINAL_PRODUCT_AMOUNT_LC: numeric("FINAL_PRODUCT_AMOUNT_LC", { precision: 30, scale: 4 }),
  REMARKS: varchar("REMARKS", { length: 2000 }),
  STATUS_ENTRY: varchar("STATUS_ENTRY", { length: 20 }),
  CREATED_BY: varchar("CREATED_BY", { length: 50 }),
  CREATED_DATE: timestamp("CREATED_DATE", { mode: "date" }),
...
export const TBL_PURCHASE_INVOICE_HDR = StoEntriesSchema.table("TBL_PURCHASE_INVOICE_HDR", {
  ...
  TOTAL_PRODUCT_HDR_AMOUNT: numeric("TOTAL_PRODUCT_HDR_AMOUNT", { precision: 30, scale: 4 }),
  TOTAL_VAT_HDR_AMOUNT: numeric("TOTAL_VAT_HDR_AMOUNT", { precision: 30, scale: 2 }),
  FINAL_INVOICE_HDR_AMOUNT: numeric("FINAL_INVOICE_HDR_AMOUNT", { precision: 30, scale: 2 }),
  EXCHANGE_RATE: numeric("EXCHANGE_RATE", { precision: 30, scale: 2 }),
  PRODUCT_HDR_AMOUNT_LC: numeric("PRODUCT_HDR_AMOUNT_LC", { precision: 30, scale: 4 }),
  TOTAL_ADDITIONAL_COST_AMOUNT_LC: numeric("TOTAL_ADDITIONAL_COST_AMOUNT_LC", { precision: 30, scale: 4 }),
  TOTAL_PRODUCT_HDR_AMOUNT_LC: numeric("TOTAL_PRODUCT_HDR_AMOUNT_LC", { precision: 30, scale: 4 }),
  TOTAL_VAT_HDR_AMOUNT_LC: numeric("TOTAL_VAT_HDR_AMOUNT_LC", { precision: 30, scale: 2 }),
  FINAL_PURCHASE_INVOICE_AMOUNT_LC: numeric("FINAL_PURCHASE_INVOICE_AMOUNT_LC", { precision: 30, scale: 2 }),
  SUBMITTED_BY: varchar("SUBMITTED_BY", { length: 50 }),
  SUBMITTED_DATE: timestamp("SUBMITTED_DATE", { mode: "date" }),
  SUBMITTED_IP_ADDRESS: varchar("SUBMITTED_IP_ADDRESS", { length: 50 }),
  RESPONSE_1_PERSON: varchar("RESPONSE_1_PERSON", { length: 50 }),
...
export const TBL_EXPENSE_HDR = StoEntriesSchema.table("TBL_EXPENSE_HDR", {
  ...
  CURRENCY_ID: integer("CURRENCY_ID").references(() => StoMasterSchema.TBL_CURRENCY_MASTER.CURRENCY_ID),
  EXCHANGE_RATE: numeric("EXCHANGE_RATE", { precision: 30, scale: 2 }),
  TOTAL_EXPENSE_AMOUNT: numeric("TOTAL_EXPENSE_AMOUNT", { precision: 30, scale: 2 }),
  TOTAL_EXPENSE_AMOUNT_LC: numeric("TOTAL_EXPENSE_AMOUNT_LC", { precision: 30, scale: 2 }),
  REMARKS: varchar("REMARKS", { length: 2000 }),
  STATUS_ENTRY: varchar("STATUS_ENTRY", { length: 20 }),
  CREATED_BY: varchar("CREATED_BY", { length: 50 }),
  CREATED_DATE: timestamp("CREATED_DATE", { mode: "date" }),
...
export const TBL_EXPENSE_DTL = StoEntriesSchema.table("TBL_EXPENSE_DTL", {
  ...
  PO_DTL_SNO: integer("PO_DTL_SNO"),
  PRODUCT_ID: integer("PRODUCT_ID").references(() => StoMasterSchema.TBL_PRODUCT_MASTER.PRODUCT_ID),
  EXPENSE_AMOUNT: numeric("EXPENSE_AMOUNT", { precision: 30, scale: 2 }),
  EXPENSE_AMOUNT_LC: numeric("EXPENSE_AMOUNT_LC", { precision: 30, scale: 2 }),
  REMARKS: varchar("REMARKS", { length: 2000 }),
  STATUS_ENTRY: varchar("STATUS_ENTRY", { length: 20 }),
  CREATED_BY: varchar("CREATED_BY", { length: 50 }),
  CREATED_DATE: timestamp("CREATED_DATE", { mode: "date" }),
...
export const TBL_SALES_ORDER_HDR = StoEntriesSchema.table("TBL_SALES_ORDER_HDR", {
  ...
  CREDIT_LIMIT_AMOUNT: numeric("CREDIT_LIMIT_AMOUNT", { precision: 30, scale: 2 }),
  CREDIT_LIMIT_DAYS: numeric("CREDIT_LIMIT_DAYS", { precision: 30, scale: 2 }),
  OUTSTANDING_AMOUNT: numeric("OUTSTANDING_AMOUNT", { precision: 30, scale: 2 }),
  CURRENCY_ID: integer("CURRENCY_ID").references(() => StoMasterSchema.TBL_CURRENCY_MASTER.CURRENCY_ID),
  EXCHANGE_RATE: numeric("EXCHANGE_RATE", { precision: 30, scale: 2 }),
  TOTAL_PRODUCT_AMOUNT: numeric("TOTAL_PRODUCT_AMOUNT", { precision: 30, scale: 4 }),
  VAT_AMOUNT: numeric("VAT_AMOUNT", { precision: 30, scale: 4 }),
  FINAL_SALES_AMOUNT: numeric("FINAL_SALES_AMOUNT", { precision: 30, scale: 4 }),
  TOTAL_PRODUCT_AMOUNT_LC: numeric("TOTAL_PRODUCT_AMOUNT_LC", { precision: 30, scale: 4 }),
  FINAL_SALES_AMOUNT_LC: numeric("FINAL_SALES_AMOUNT_LC", { precision: 30, scale: 4 }),
  REMARKS: varchar("REMARKS", { length: 2000 }),
...
export const TBL_SALES_ORDER_DTL = StoEntriesSchema.table("TBL_SALES_ORDER_DTL", {
  ...
  SUB_CATEGORY_ID: integer("SUB_CATEGORY_ID").references(() => StoMasterSchema.TBL_PRODUCT_SUB_CATEGORY_MASTER.SUB_CATEGORY_ID),
  PRODUCT_ID: integer("PRODUCT_ID").references(() => StoMasterSchema.TBL_PRODUCT_MASTER.PRODUCT_ID),
  STORE_STOCK_PCS: numeric("STORE_STOCK_PCS", { precision: 30, scale: 4 }),
  PO_REF_NO: varchar("PO_REF_NO", { length: 50 }),
  PO_DTL_SNO: integer("PO_DTL_SNO"),
  PO_DTL_STOCK_QTY: numeric("PO_DTL_STOCK_QTY", { precision: 30, scale: 4 }),
  PURCHASE_RATE_PER_QTY: numeric("PURCHASE_RATE_PER_QTY", { precision: 30, scale: 6 }),
  PO_EXPENSE_AMOUNT: numeric("PO_EXPENSE_AMOUNT", { precision: 30, scale: 4 }),
  SALES_RATE_PER_QTY: numeric("SALES_RATE_PER_QTY", { precision: 30, scale: 6 }),
  QTY_PER_PACKING: numeric("QTY_PER_PACKING", { precision: 30, scale: 2 }),
  TOTAL_QTY: numeric("TOTAL_QTY", { precision: 30, scale: 4 }),
  UOM: varchar("UOM", { length: 50 }),
  TOTAL_PACKING: numeric("TOTAL_PACKING", { precision: 30, scale: 4 }),
...
export const TBL_DELIVERY_NOTE_DTL = StoEntriesSchema.table("TBL_DELIVERY_NOTE_DTL", {
  ...
  SALES_RATE_PER_QTY: numeric("SALES_RATE_PER_QTY", { precision: 30, scale: 6 }),
  QTY_PER_PACKING: numeric("QTY_PER_PACKING", { precision: 30, scale: 2 }),
  REQUEST_QTY: numeric("REQUEST_QTY", { precision: 30, scale: 4 }),
  DELIVERY_QTY: numeric("DELIVERY_QTY", { precision: 30, scale: 4 }),
  UOM: varchar("UOM", { length: 50 }),
  TOTAL_PACKING: numeric("TOTAL_PACKING", { precision: 30, scale: 4 }),
  ALTERNATE_UOM: varchar("ALTERNATE_UOM", { length: 500 }),
  TOTAL_PRODUCT_AMOUNT: numeric("TOTAL_PRODUCT_AMOUNT", { precision: 30, scale: 4 }),
  ...
  TOTAL_PRODUCT_AMOUNT_LC: numeric("TOTAL_PRODUCT_AMOUNT_LC", { precision: 30, scale: 4 }),
  FINAL_SALES_AMOUNT_LC: numeric("FINAL_SALES_AMOUNT_LC", { precision: 30, scale: 4 }),
  STORE_STOCK_PCS: numeric("STORE_STOCK_PCS", { precision: 30, scale: 2 }),
  REMARKS: varchar("REMARKS", { length: 2000 }),
  STATUS_ENTRY: varchar("STATUS_ENTRY", { length: 20 }),
  CREATED_BY: varchar("CREATED_BY", { length: 50 }),
  CREATED_DATE: timestamp("CREATED_DATE", { mode: "date" }),
...
export const TBL_TAX_INVOICE_DTL = StoEntriesSchema.table("TBL_TAX_INVOICE_DTL", {
  ...
  QTY_PER_PACKING: numeric("QTY_PER_PACKING", { precision: 30, scale: 2 }),
  DELIVERY_QTY: numeric("DELIVERY_QTY", { precision: 30, scale: 4 }),
  INVOICE_QTY: numeric("INVOICE_QTY", { precision: 30, scale: 4 }),
  UOM: varchar("UOM", { length: 50 }),
  TOTAL_PACKING: numeric("TOTAL_PACKING", { precision: 30, scale: 4 }),
  ALTERNATE_UOM: varchar("ALTERNATE_UOM", { length: 500 }),
  TOTAL_PRODUCT_AMOUNT: numeric("TOTAL_PRODUCT_AMOUNT", { precision: 30, scale: 4 }),
...
export const TBL_CUSTOMER_RECEIPT_HDR = StoEntriesSchema.table("TBL_CUSTOMER_RECEIPT_HDR", {
  ...
  CURRENCY_ID: integer("CURRENCY_ID").references(() => StoMasterSchema.TBL_CURRENCY_MASTER.CURRENCY_ID),
  RECEIPT_AMOUNT: numeric("RECEIPT_AMOUNT", { precision: 30, scale: 2 }),
  EXCHANGE_RATE: numeric("EXCHANGE_RATE", { precision: 30, scale: 2 }),
  RECEIPT_AMOUNT_LC: numeric("RECEIPT_AMOUNT_LC", { precision: 30, scale: 2 }),
  REMARKS: varchar("REMARKS", { length: 1000 }),
  STATUS_ENTRY: varchar("STATUS_ENTRY", { length: 20 }),
  CREATED_BY: varchar("CREATED_BY", { length: 50 }),
  CREATED_DATE: timestamp("CREATED_DATE", { mode: "date" }),
...
export const TBL_CUSTOMER_RECEIPT_INVOICE_DTL = StoEntriesSchema.table("TBL_CUSTOMER_RECEIPT_INVOICE_DTL", {
  ...
  RECEIPT_INVOICE_ADJUST_AMOUNT: numeric("RECEIPT_INVOICE_ADJUST_AMOUNT", { precision: 30, scale: 2 }),
  REMARKS: varchar("REMARKS", { length: 1000 }),
  STATUS_ENTRY: varchar("STATUS_ENTRY", { length: 20 }),
  CREATED_BY: varchar("CREATED_BY", { length: 50 }),
  CREATED_DATE: timestamp("CREATED_DATE", { mode: "date" }),
