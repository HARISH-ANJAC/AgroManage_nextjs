...
CREATE TABLE "stomaster"."tbl_Customer_Credit_Limit_Details" (
	...
	"Requested_Credit_Limit_Amount" numeric(30, 2),
	"Requested_Payment_Mode_Id" integer,
	"Requested_By" varchar(50),
	"Requested_Date" timestamp,
	"Total_Outstanding_Amount" numeric(30, 2),
	"Over_Due_Outstanding_Amount" numeric(30, 2),
	"Approved_Credit_Limit_Days" integer,
	"Approved_Credit_Limit_Amount" numeric(30, 2),
...
CREATE TABLE "stomaster"."tbl_Customer_Wise_Product_Price_Settings" (
	...
	"Requested_By" varchar(50),
	"Requested_Date" timestamp,
	"Requested_Product_Amount" numeric(30, 4),
	"Approved_Product_Amount" numeric(30, 4),
	"Respond_By" varchar(50),
...
CREATE TABLE "stomaster"."tbl_District_Master" (
	...
	"Total_Population" numeric(30, 2),
	"Zone_Name" varchar(50),
	"Distance_From_Arusha" numeric(30, 2),
	"Status_Master" varchar(20),
	"Created_By" varchar(50),
	"Created_Date" timestamp,
	"Created_Mac_Address" varchar(50),
...
CREATE TABLE "stomaster"."tbl_Store_Product_Minimum_Stock" (
	...
	"Purchase_Alert_Qty" numeric(30, 2),
	"Requested_By" varchar(50),
	"Effective_From" timestamp,
	"Effective_To" timestamp,
	"Remarks" varchar(2000),
...
CREATE TABLE "stomaster"."tbl_Supplier_Master" (
	...
	"Fax" varchar(50),
	"vat_Percentage" numeric(30, 2),
	"Withholding_vat_percentage" numeric(30, 2),
	"Remarks" varchar(150),
	"Status_Master" varchar(20),
	"Created_User" varchar(50),
	"Created_Date" timestamp,
...
CREATE TABLE "stoentries"."TBL_CUSTOMER_RECEIPT_HDR" (
	...
	"CURRENCY_ID" integer,
	"RECEIPT_AMOUNT" numeric(30, 2),
	"EXCHANGE_RATE" numeric(30, 2),
	"RECEIPT_AMOUNT_LC" numeric(30, 2),
	"REMARKS" varchar(1000),
...
CREATE TABLE "stoentries"."TBL_CUSTOMER_RECEIPT_INVOICE_DTL" (
	...
	"RECEIPT_INVOICE_ADJUST_AMOUNT" numeric(30, 2),
	"REMARKS" varchar(1000),
	"STATUS_ENTRY" varchar(20),
	"CREATED_BY" varchar(50),
	"CREATED_DATE" timestamp,
...
CREATE TABLE "stoentries"."TBL_DELIVERY_NOTE_DTL" (
	...
	"SUB_CATEGORY_ID" integer,
	"PRODUCT_ID" integer,
	"SALES_RATE_PER_QTY" numeric(30, 6),
	"QTY_PER_PACKING" numeric(30, 2),
	"REQUEST_QTY" numeric(30, 4),
	"DELIVERY_QTY" numeric(30, 4),
	"UOM" varchar(50),
	"TOTAL_PACKING" numeric(30, 4),
	"ALTERNATE_UOM" varchar(500),
	"TOTAL_PRODUCT_AMOUNT" numeric(30, 4),
	"VAT_PERCENTAGE" numeric(30, 2),
	"VAT_AMOUNT" numeric(30, 4),
	"FINAL_SALES_AMOUNT" numeric(30, 4),
	"TOTAL_PRODUCT_AMOUNT_LC" numeric(30, 4),
	"FINAL_SALES_AMOUNT_LC" numeric(30, 4),
	"STORE_STOCK_PCS" numeric(30, 2),
	"REMARKS" varchar(2000),
	"STATUS_ENTRY" varchar(20),
	"CREATED_BY" varchar(50),
	"CREATED_DATE" timestamp,
...
CREATE TABLE "stoentries"."TBL_EXPENSE_DTL" (
	...
	"PO_DTL_SNO" integer,
	"PRODUCT_ID" integer,
	"EXPENSE_AMOUNT" numeric(30, 2),
	"EXPENSE_AMOUNT_LC" numeric(30, 2),
	"REMARKS" varchar(2000),
	"STATUS_ENTRY" varchar(20),
	"CREATED_BY" varchar(50),
	"CREATED_DATE" timestamp,
...
CREATE TABLE "stoentries"."TBL_EXPENSE_HDR" (
	...
	"CURRENCY_ID" integer,
	"EXCHANGE_RATE" numeric(30, 2),
	"TOTAL_EXPENSE_AMOUNT" numeric(30, 2),
	"TOTAL_EXPENSE_AMOUNT_LC" numeric(30, 2),
	"REMARKS" varchar(2000),
	"STATUS_ENTRY" varchar(20),
	"CREATED_BY" varchar(50),
	"CREATED_DATE" timestamp,
...
CREATE TABLE "stoentries"."TBL_PURCHASE_INVOICE_DTL" (
	...
	"TOTAL_PACKING" numeric(30, 4),
	"ALTERNATE_UOM" varchar(500),
	"RATE_PER_QTY" numeric(30, 6),
	"PRODUCT_AMOUNT" numeric(30, 4),
	"DISCOUNT_PERCENTAGE" numeric(30, 2),
	"DISCOUNT_AMOUNT" numeric(30, 4),
	"TOTAL_PRODUCT_AMOUNT" numeric(30, 4),
	"VAT_PERCENTAGE" numeric(30, 2),
	"VAT_AMOUNT" numeric(30, 4),
	"FINAL_PRODUCT_AMOUNT" numeric(30, 4),
	"TOTAL_PRODUCT_AMOUNT_LC" numeric(30, 4),
	"FINAL_PRODUCT_AMOUNT_LC" numeric(30, 4),
	"REMARKS" varchar(2000),
	"STATUS_ENTRY" varchar(20),
	"CREATED_BY" varchar(50),
	"CREATED_DATE" timestamp,
...
CREATE TABLE "stoentries"."TBL_PURCHASE_INVOICE_HDR" (
	...
	"PRODUCT_HDR_AMOUNT" numeric(30, 4),
	"TOTAL_ADDITIONAL_COST_AMOUNT" numeric(30, 4),
	"TOTAL_PRODUCT_HDR_AMOUNT" numeric(30, 4),
	"TOTAL_VAT_HDR_AMOUNT" numeric(30, 2),
	"FINAL_INVOICE_HDR_AMOUNT" numeric(30, 2),
	"EXCHANGE_RATE" numeric(30, 2),
	"PRODUCT_HDR_AMOUNT_LC" numeric(30, 4),
	"TOTAL_ADDITIONAL_COST_AMOUNT_LC" numeric(30, 4),
	"TOTAL_PRODUCT_HDR_AMOUNT_LC" numeric(30, 4),
	"TOTAL_VAT_HDR_AMOUNT_LC" numeric(30, 2),
	"FINAL_PURCHASE_INVOICE_AMOUNT_LC" numeric(30, 2),
	"SUBMITTED_BY" varchar(50),
	"SUBMITTED_DATE" timestamp,
	"SUBMITTED_IP_ADDRESS" varchar(50),
...
CREATE TABLE "stoentries"."TBL_PURCHASE_ORDER_HDR" (
	...
	"TOTAL_PRODUCT_HDR_AMOUNT" numeric(30, 4),
	"TOTAL_VAT_HDR_AMOUNT" numeric(30, 2),
	"FINAL_PURCHASE_HDR_AMOUNT" numeric(30, 2),
	"EXCHANGE_RATE" numeric(30, 2),
	"PRODUCT_HDR_AMOUNT_LC" numeric(30, 4),
	"TOTAL_ADDITIONAL_COST_AMOUNT_LC" numeric(30, 4),
	"TOTAL_PRODUCT_HDR_AMOUNT_LC" numeric(30, 4),
	"TOTAL_VAT_HDR_AMOUNT_LC" numeric(30, 2),
	"FINAL_PURCHASE_HDR_AMOUNT_LC" numeric(30, 2),
	"SUBMITTED_BY" varchar(50),
	"SUBMITTED_DATE" timestamp,
	"SUBMITTED_IP_ADDRESS" varchar(50),
...
CREATE TABLE "stoentries"."TBL_SALES_ORDER_DTL" (
	...
	"SUB_CATEGORY_ID" integer,
	"PRODUCT_ID" integer,
	"STORE_STOCK_PCS" numeric(30, 4),
	"PO_REF_NO" varchar(50),
	"PO_DTL_SNO" integer,
	"PO_DTL_STOCK_QTY" numeric(30, 4),
	"PURCHASE_RATE_PER_QTY" numeric(30, 6),
	"PO_EXPENSE_AMOUNT" numeric(30, 4),
	"SALES_RATE_PER_QTY" numeric(30, 6),
	"QTY_PER_PACKING" numeric(30, 2),
	"TOTAL_QTY" numeric(30, 4),
	"UOM" varchar(50),
...
CREATE TABLE "stoentries"."TBL_SALES_ORDER_HDR" (
	...
	"CREDIT_LIMIT_AMOUNT" numeric(30, 2),
	"CREDIT_LIMIT_DAYS" numeric(30, 2),
	"OUTSTANDING_AMOUNT" numeric(30, 2),
	"CURRENCY_ID" integer,
	"EXCHANGE_RATE" numeric(30, 2),
	"TOTAL_PRODUCT_AMOUNT" numeric(30, 4),
	"VAT_AMOUNT" numeric(30, 4),
