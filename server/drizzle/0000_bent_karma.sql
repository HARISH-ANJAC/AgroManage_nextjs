...
ALTER TABLE "StoEntries"."TBL_PURCHASE_INVOICE_ADDITIONAL_COST_DETAILS" ADD CONSTRAINT "TBL_PURCHASE_INVOICE_ADDITIONAL_COST_DETAILS_PURCHASE_INVOICE_NO_TBL_PURCHASE_ORDER_HDR_PO_REF_NO_fk" FOREIGN KEY ("PURCHASE_INVOICE_NO") REFERENCES "StoEntries"."TBL_PURCHASE_ORDER_HDR"("PO_REF_NO") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "StoEntries"."TBL_PURCHASE_INVOICE_DTL" ADD CONSTRAINT "TBL_PURCHASE_INVOICE_DTL_PURCHASE_INVOICE_REF_NO_TBL_PURCHASE_ORDER_HDR_PO_REF_NO_fk" FOREIGN KEY ("PURCHASE_INVOICE_REF_NO") REFERENCES "StoEntries"."TBL_PURCHASE_ORDER_HDR"("PO_REF_NO") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "StoEntries"."TBL_PURCHASE_INVOICE_FILES_UPLOAD" ADD CONSTRAINT "TBL_PURCHASE_INVOICE_FILES_UPLOAD_PURCHASE_INVOICE_REF_NO_TBL_PURCHASE_ORDER_HDR_PO_REF_NO_fk" FOREIGN KEY ("PURCHASE_INVOICE_REF_NO") REFERENCES "StoEntries"."TBL_PURCHASE_ORDER_HDR"("PO_REF_NO") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
